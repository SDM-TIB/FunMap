...
const doMapping = async () => {
  try{
    ...
    aux5 = fs.readFileSync('./output/PROJECT5.csv', 'utf8')
    aux6 = fs.readFileSync('./output/PROJECT6.csv', 'utf8')
    aux7 = fs.readFileSync('./output/PROJECT7.csv', 'utf8')
    aux8 = fs.readFileSync('./output/PROJECT8.csv', 'utf8')
    aux9 = fs.readFileSync('./output/PROJECT9.csv', 'utf8')
    aux10 = fs.readFileSync('./output/PROJECT10.csv', 'utf8')
  ...
  let inputFiles = {
    ...
    "./output/PROJECT5.csv": aux5,
    "./output/PROJECT6.csv": aux6,
    "./output/PROJECT7.csv": aux7,
    "./output/PROJECT8.csv": aux8,
    "./output/PROJECT9.csv": aux9,
    "./output/PROJECT10.csv": aux10,
  };
  const options = {
    toRDF: true,
    verbose: true,
